    ...
    public function flea(){
        ...
        if (request()->isPost()){
            if (!empty($_POST['del_id'])){
                $flea_model->delFlea(implode(',',$_POST['del_id']));
                $this->success(lang('goods_index_del_succ'));
            }else {
                $this->error(lang('goods_index_choose_del'));
            }
            $this->error(lang('goods_index_argument_invalid'));
        }
